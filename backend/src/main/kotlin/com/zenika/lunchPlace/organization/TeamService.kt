...
open class TeamService @Autowired constructor(val teamRepository: TeamRepository,
     ...
     */
    fun getDailyRestaurant(team: Team): Restaurant? {
...
//        val nbRestaurants: Int = team.restaurants.size
//
//        //if there's no restaurant at all, just send back an empty one
//        if (team.restaurants.isEmpty())
//            return null
//
...
//
//            todayRestaurant = team.restaurants[choosenRestaurantIndex].restaurant
//        }
...
//            for (i in team.restaurants.indices) {
//
//                var weight = team.restaurants[i].teamReview
...
//                val preferredRestaurant: Restaurant = team.restaurants[i].restaurant
